...
with increased/decreased samples in rows and predictors in columns. In theory
manipulation of predictors to generate additional, composite predictors would be
supported here.
