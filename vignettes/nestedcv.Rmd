...
of the whole dataset for testing overall accuracy, but maintaining the split
between training and testing.

In addition typical biomedical datasets often have 10,000s of possible
predictors, so filtering of predictors is common. However, it has been
demonstrated that filtering on the whole dataset creates a bias when determining
accuracy of model. Thus, it is recommended that any filtering of predictors is
performed within the CV loops, to prevent data leakage.
