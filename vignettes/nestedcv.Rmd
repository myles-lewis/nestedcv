...
the whole dataset. Unfortunately this is commonly observed in many studies which
use differential expression analysis on the whole dataset to select predictors
which are then passed to machine learning algorithms.
