...
fastshap_eval <- requireNamespace("fastshap", quietly = TRUE)
```
...
```{r, eval = fastshap_eval, fig.width = 9, fig.height = 3.5}
library(ggplot2)
data("iris")
dat <- iris
y <- dat$Species
...
```{r, eval = fastshap_eval, fig.width = 9.5, fig.height = 3.5}
