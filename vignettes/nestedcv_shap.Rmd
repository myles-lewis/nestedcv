...
importance for predictors is measured using Shapley values.
...
`nestedcv` provides a quick plotting function `plot_shap_beeswarm` for
...
s2 <- plot_shap_beeswarm(sh3, x, sort = FALSE, cex = 0.7) +
  ggtitle("virginica") +
  guides(y = "none")
